...
compile-raspbian:
	...
	cd src && javac -classpath /usr/share/java/swt-gtk-3.8.jar:. Main.java PrinterCommand.java USBThermalPrinter.java

# Building Jar for Raspbian.
jar-raspbian:
	cd src && cp raspbian/Manifest ./ && jar -cfm ../bin/app.jar Manifest Main.class PrinterCommand.class USBThermalPrinter.class
...
jar-mac:
	...
	cd src && cp mac/Manifest ./ && jar -cfm ../bin/app.jar Manifest Main.class PrinterCommand.class USBThermalPrinter.class
